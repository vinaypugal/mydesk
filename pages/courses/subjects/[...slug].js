          ...
          <div className="col-lg-4 col-md-4 d-flex align-items-stretch">
            <div className="course-item">
              ...
              <div className="course-content">
                ...
                <a href="9th-state.html">View More <i className="bx bx-link" /></a> <br /><br />
                <p>Et architecto provident deleniti facere repellat nobis iste. Id facere quia quae dolores dolorem tempore. Et architecto provident deleniti facere</p>
              </div>
            </div>
          </div> {/* End Course Item*/}
          <div className="col-lg-4 col-md-4 d-flex align-items-stretch mt-4 mt-md-0">
            <div className="course-item">
              ...
              <div className="course-content">
                ...
                <a href="10th-state.html">View More <i className="bx bx-link" /></a> <br /><br />
                <p>Et architecto provident deleniti facere repellat nobis iste. Id facere quia quae dolores dolorem tempore. Et architecto provident deleniti facere </p>
              </div>
            </div>
          </div> {/* End Course Item*/}
          <div className="col-lg-4 col-md-4 d-flex align-items-stretch mt-4 mt-lg-0">
            <div className="course-item">
              ...
              <div className="course-content">
                ...
                <a href="11th-state.html">View More <i className="bx bx-link" /></a> <br /><br />
                <p>Et architecto provident deleniti facere repellat nobis iste. Id facere quia quae dolores dolorem tempore. Et architecto provident deleniti facere </p>
              </div>
            </div> {/* End Course Item*/}
          </div>
